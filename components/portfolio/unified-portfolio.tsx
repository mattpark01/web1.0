...
export function UnifiedPortfolio() {
  ...
  const { tokenBalances, totalValue: web3TotalValue, loading: web3Loading } = useWeb3Holdings()
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardDescription>Web3 Assets</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            disabled={loading || web3Loading || investmentsLoading}
          >
            <RefreshCw className={`h-4 w-4 mr-2 ${(loading || web3Loading || investmentsLoading) ? 'animate-spin' : ''}`} />
            Refresh
          </Button>
        </div>
      </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant="outline" className="text-xs">
                        {position.source === 'web3' ? (
                          <><Wallet className="h-3 w-3 mr-1" /> Web3</>
                        ) : (
